    ...
    <div className='project-card'>
        <div className="project-card-container">
            <div className="project-card-head">
                ...
                {data.link ? <a className='project-title clickable' href={data.link} target='_BLANK' rel="noreferrer">{data.name} - {data.year}</a> : <p className='project-title'>{data.name} - {data.year}</p>} 
            </div>
